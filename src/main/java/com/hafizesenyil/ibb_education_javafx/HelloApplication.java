package com.hafizesenyil.ibb_education_javafx;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException, SQLException {
        ...
        // view/admin.fxml --> aşağıdaki kodda login yerine admin yaparsak authencation olmadan sisteme girilebilir
    ...
    """;
        ...
        try (PreparedStatement ps = connection.prepareStatement(insertSQL)) {
            // 1. kullanıcı
            ps.setString(1, "hafizesenyil");
            ps.setString(2, BCrypt.hashpw("root", BCrypt.gensalt()));
            ps.setString(3, "hfz.snyl@gmail.com");
            ps.setString(4, "USER");
            ps.executeUpdate();
